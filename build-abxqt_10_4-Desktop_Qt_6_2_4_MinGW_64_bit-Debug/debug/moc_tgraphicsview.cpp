...
#include <memory>
#include "../../abxqt_10_4/tgraphicsview.h"
...
QT_MOC_LITERAL(36, 12) // "mouseClicked"
    ...
    "TGraphicsView\0mouseMovePoint\0\0point\0"
    "mouseClicked"
};
...
void TGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TGraphicsView::mouseMovePoint)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<TGraphicsView, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPoint, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPoint, std::false_type>
