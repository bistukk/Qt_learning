...
#include <memory>
#include "../../abxqt_09_3/tdialogdata.h"
...
struct qt_meta_stringdata_TDialogData_t {
    const uint offsetsAndSize[8];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TDialogData_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TDialogData_t qt_meta_stringdata_TDialogData = {
    {
...
QT_MOC_LITERAL(35, 23) // "on_pushButton_2_clicked"
    ...
    "TDialogData\0on_pushButton_clicked\0\0"
    "on_pushButton_2_clicked"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TDialogData[] = {
...
const QMetaObject TDialogData::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_TDialogData.offsetsAndSize,
    qt_meta_data_TDialogData,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TDialogData_t
...
void *TDialogData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TDialogData.stringdata0))
